            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50 border-b border-slate-200">
                        ...
                        <th class="px-6 py-4 font-bold text-slate-600 text-xs uppercase tracking-wider">CRM Approval</th>
                            ...
                            <td class="px-6 py-4">
                                @if($learner->ms_user_id)
                                    <div class="flex items-center gap-1.5 text-slate-700">
                                        <svg class="h-4 w-4 text-ds-pink" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
