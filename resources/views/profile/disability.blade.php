...
<head>
    <meta charset="UTF-8">
    <title>Disability Information - DirectSkills Portal</title>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto px-4">
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6 space-y-4">
                <h1 class="text-xl font-semibold text-slate-800">Disability Information</h1>
                <p class="text-sm text-slate-500">
                    If you do not have any disability or learning difficulty to declare, please confirm below.
                </p>

                <form method="POST" action="{{ route('portal.profile.disability.update') }}" class="space-y-4">
                    @csrf

                    <label class="flex items-start gap-2 text-sm text-slate-700">
                        <input type="checkbox" name="confirm_no_disability" value="1"
                               class="mt-1">
                        <span>
                            I confirm that I <strong>do not have any disability or learning difficulty</strong> to declare at this time.
                        </span>
                    </label>
