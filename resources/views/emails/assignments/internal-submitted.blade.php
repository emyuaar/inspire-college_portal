        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.05); max-width: 600px; width: 100%;">
                    <!-- Header -->
                    <tr>
                        <td align="center" style="background-color: #01345B; padding: 30px 20px; border-bottom: 4px solid #d63384;">
                            <img src="https://directskills.co.uk/images/DirectSKills%20inverted-02.png" alt="DirectSkills Logo" width="220" style="display: block; max-width: 220px; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 35px 35px 20px 35px; text-align: center;">
                            <h1 style="margin: 0; font-size: 26px; font-weight: 700; color: #01345B;">New Assignment Submission</h1>
                    ...
                    <tr>
                        <td style="padding: 15px 35px 30px 35px;">
                            <!-- Learner Card -->
                            <h2 style="font-size: 18px; color: #01345B; margin: 0 0 12px 0; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px;">Learner Details</h2>
                                    ...
                                    <td style="padding: 18px 25px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 6px 0; font-size: 15px; color: #01345B; font-weight: 500;">{{ $learnerEmail ?? 'N/A' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <!-- Submission Card -->
                            <h2 style="font-size: 18px; color: #01345B; margin: 0 0 12px 0; border-bottom: 2px solid #e2e8f0; padding-bottom: 8px;">Submission Details</h2>
                                    ...
                                    <td style="padding: 20px 25px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 8px 0; border-bottom: 1px solid #edf2f7; font-size: 15px; color: #01345B; font-weight: 600; word-break: break-all;">{{ $fileName ?? 'N/A' }}</td>
                                            </tr>
                                            <tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="text-align: center; margin-bottom: 35px;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $submissionUrl ?? '#' }}" style="background-color: #01345B; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 8px; display: inline-block; font-weight: 700; font-size: 16px; border-bottom: 3px solid #001f38; box-shadow: 0 4px 6px rgba(1, 52, 91, 0.2);">
                            ...
                            <p style="font-size: 16px; line-height: 24px; color: #333333; margin: 0;">
                                Regards,<br>
                                <strong>DirectSkills Assessment System</strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style="background-color: #01345B; padding: 25px 30px; text-align: center; border-top: 1px solid #104b77;">
                            <p style="margin: 0 0 10px 0; font-size: 16px; font-weight: 700; color: #ffffff; letter-spacing: 0.5px;">DirectSkills</p>
                            <p style="margin: 0 0 5px 0; font-size: 13px; color: #cbd5e1;">This is an automated notification from the DirectSkills Assessment System.</p>
